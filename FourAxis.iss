...
[Icons]
Name: "{group}\{#MyAppName}"; Filename: "{app}\FourAxis\Run.bat"; WorkingDir: "{app}\FourAxis";
Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\FourAxis\Run.bat"; WorkingDir: "{app}\FourAxis"; Tasks: desktopicon
